...
* The training and testing data are obtained from the respective list objects and merged, columns of the resulting data frame is named temporarily to allow for *dplyr::join* to be used later on.
...
* Both tidy datasets are exported as txt.
